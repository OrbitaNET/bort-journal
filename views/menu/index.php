...
<div class="card mb-3 group-card" data-id="<?= $group->id ?>">
    <div class="card-header d-flex justify-content-between align-items-center gap-2">
        ...
        <strong class="flex-grow-1"><?= Html::encode($group->localizedName) ?></strong>
        <div class="d-flex gap-2">
            ...
            <?= Html::a(Yii::t('app', 'Delete'), ['delete-group', 'id' => $group->id], [
                ...
                'data-confirm' => Yii::t('app', 'Delete group "{name}"? Items will become ungrouped.', ['name' => $group->localizedName]),
                'data-method' => 'post',
            ]) ?>
        </div>
    </div>
