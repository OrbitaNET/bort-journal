    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                ['pattern' => 'api/applications/<id:\d+>',               'route' => 'api/application',         'verb' => 'GET'],
                ['pattern' => 'api/applications/<id:\d+>',               'route' => 'api/update-application',  'verb' => 'PUT'],
                ['pattern' => 'api/applications/<id:\d+>',               'route' => 'api/delete-application',  'verb' => 'DELETE'],
                ['pattern' => 'api/applications/<id:\d+>/confirm',         'route' => 'api/confirm-application', 'verb' => 'POST'],
                ['pattern' => 'api/applications/<id:\d+>/send-processing', 'route' => 'api/send-processing',   'verb' => 'POST'],
                ['pattern' => 'api/applications/<id:\d+>/send-pdf',        'route' => 'api/send-pdf',          'verb' => 'POST'],
            ],
        ],
    ],
    'params' => $params,
